...
REM
REM Generated by Vivado on Wed Apr 29 17:39:57 +0530 2026
...
echo "xvhdl --incr --relax -prj TB_Adder_3_B_vhdl.prj"
call xvhdl  --incr --relax -prj TB_Adder_3_B_vhdl.prj -log xvhdl.log
